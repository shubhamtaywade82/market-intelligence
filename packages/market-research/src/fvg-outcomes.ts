...
export function evaluateFvgOutcome(
  ...
  return {
    ...
    mfeR: risk.gt(0) ? maxFav.dividedBy(risk) : new Decimal(0),
    maeR: risk.gt(0) ? maxAdv.dividedBy(risk) : new Decimal(0),
    ...
    timeToTarget: null,
    timeToStop: null,
    targetHit1R: maxFav.gte(risk),
    targetHit2R: hit2R,
    targetHit3R: maxFav.gte(risk.times(3)),
